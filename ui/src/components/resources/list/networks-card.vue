<template>
    <v-card class="overflow-auto" id="networks-card">
        ...
        <v-list>
            ...
            <v-row>
                <v-col>
                    <v-list-item v-if="resource.IPAM.Config[0] && resource.IPAM.Config[0]['Subnet']">
                        <v-list-item-title>subnet</v-list-item-title>
                        <v-list-item-subtitle>{{ resource.IPAM.Config[0]['Subnet'] }}</v-list-item-subtitle>
                    </v-list-item>
                </v-col>
                <v-col>
                    <v-list-item v-if="resource.IPAM.Config[0] && resource.IPAM.Config[0]['Gateway']">
